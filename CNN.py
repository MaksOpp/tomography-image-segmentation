...
retVal = model.fit(np.array(framObjTrain['img']), np.array(framObjTrain['mask']), epochs = 4, verbose = 1, validation_split = 0.1, batch_size=1, shuffle = True, callbacks=callbacks_list, initial_epoch=initial_epoch) 
