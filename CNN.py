...
img_path = 'raid//final_data//test//images'
mask_path = 'raid//final_data//test//labels'

validation_img_path = 'raid//final_data//val//images'
validation_mask_path = 'raid//final_data//val//labels'
...
retVal = model.fit(np.array(framObjTrain['img']), np.array(framObjTrain['mask']), epochs = 100, verbose = 1, validation_split=0.1, batch_size=32, shuffle = True, callbacks=callbacks_list, initial_epoch=initial_epoch) 
